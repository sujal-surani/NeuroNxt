...
import { CheckCircle, XCircle, UserPlus, Users, GraduationCap, Building, LogOut, Mail } from "lucide-react"
                ...
                <Tabs defaultValue="pending" className="space-y-6">
                    ...
                    <TabsContent value="teachers" className="space-y-4">
                        <div className="flex justify-between items-center">
                            ...
                            <AddTeacherDialog instituteCode={instituteCode} />
                        </div>
                        <Card>
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="text-xs text-muted-foreground mt-1">
                                                            {formatBranchName(student.user_metadata.branch)} • Sem {student.user_metadata.semester}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="flex items-center gap-2">
