...
const notifications = [
  {
    ...
    description: "Hey! Can you share your Data Structures notes?",
    time: "2 min ago",
    unread: true,
  ...
  },
  {
    ...
    description: "Alex Kumar wants to connect with you",
    time: "5 min ago",
    unread: true,
    avatar: "/student-avatar.png",
    icon: Users,
  },
  {
    ...
    type: "note",
    title: "Note liked",
    description: "Your Machine Learning notes got 5 new likes",
    time: "1 hour ago",
    unread: false,
    icon: BookOpen,
  },
  {
    ...
    description: "You've reached Level 12 - Study Master",
    time: "2 hours ago",
    unread: false,
    icon: Trophy,
  },
  {
    ...
    description: "CS Semester 6: 3 new messages",
    time: "3 hours ago",
    unread: false,
    icon: MessageCircle,
  },
            ...
            {notificationList.length === 0 ? (
              ...
              notificationList.map((notification) => {
                ...
                return (
                  <div
                    key={notification.id}
                    className={`flex items-start space-x-3 p-3 rounded-lg hover:bg-muted/50 cursor-pointer transition-all duration-200 ${
